...
const avatarUrl = ref(props.user.details.image);
...
const submitForm = async () => {
    ...
    formData.append('country', form.user.details.country);
    formData.append('name', form.user.name);
    console.log(selectedFile.value)
    if(selectedFile.value !== null && selectedFile.value !== "null") {
        formData.append('photo', selectedFile.value);
    }
    try {
        const response = await axios.post('/profile/save', formData, {
            headers: {
...
<template>
    <form class="account-user form" action="/">
        ...
        <div class="account-user__bottom">
            ...
            <div class="account-user__group row">
                ...
                <div class="col-lg-6">
                    <div class="form-item">
                        ...
                        <select v-model="form.user.details.country" class="form-select">
            ...
            <button class="account-user__btn btn btn-black" @click.prevent="()=>submitForm()">{{ buttonText }}</button>
        </div>
    </form>
</template>
